<div class="container">
    <div id="clasepadre">
        <div class="form-wrap">
            <form id="survey-form">
                <h4 class="text-red">Editando a <b>{{ $name }}</b></h4>
                <hr>
                <div class="row">
                    ...
                    @if ($privilegio == 1)
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" wire:model='foto_url_update'
                                    accept="image/x-png,image/gif,image/jpeg" placeholder="Adjuntar foto"
                                    class="form-control" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" wire:model='firma_url_update'
                                    accept="image/x-png,image/gif,image/jpeg" placeholder="Adjuntar firma"
                                    class="form-control" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label id="name-label" for="genero">Género</label>
                            <select wire:model="genero" class="form-control" id="" required>
                                <option value="">Seleccionar</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" wire:model='fecha_nacimiento'
                                placeholder="seleccionar fecha de nacimiento" maxlength="9"
                ...
                <div class="form-actions">
                    <div class="text-left">
                        <button wire:click="update" wire:loading.attr="disabled" class="btn btn-primary btn-sm"
                            type="button"> <i class="fa fa-edit"></i> <i wire:target="update"
